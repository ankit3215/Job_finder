...
import { authAddUser, authVerifyUser, checkUserStatus, removeAuthToken, googleAuth, setAccessToken } from "../../services/authServices";
...
export { registerUser, signInUser, updateUser, setUserData, logOutUser, signUpWithGoogle, loginWithGoogle};