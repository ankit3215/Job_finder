...
function Profile2(props) {
  ...
  }, [ids, names, phones, cities, states, countries, companiesName]);
  ...
  return (
    <>
    <Center><Avatar  className={classes.large}
  ...
  /></Center>
      <Center>
        <form onSubmit={submitHandler}>
          ...
          />
          <br />
          <Typography>Company's Address</Typography>
          <Input
            type="text"
            required="true"
            fullWidth="true"
